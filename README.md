...
**Project status:** RP-TURN-019-R4-DIAG4 future non-mutating elevation-probe mode is implemented pending Project Codex review; RP-TURN-019 remains Partial, the recovered host remains at zero residue and the candidate remains unsigned, uninstalled and not production-approved  
