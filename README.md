...
**Project status:** RP-TURN-019-R4-NODE-DIAG2-R2 hermetic Windows PowerShell module-loading correction is implemented pending Project Codex review; RP-TURN-019 remains Partial, the protected Node destination remains unknown and the candidate remains unsigned, uninstalled and not production-approved  
