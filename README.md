...
**Project status:** RP-TURN-019-R1B-PHASE2D authorized; stale drain state removed under its exact accepted ACL boundary and canonical ACL/atomic-state correction is under verification before one final non-reboot rehearsal  
