...
**Project status:** RP-TURN-019-R4-NODE-DIAG6 durable parent-entry/pre-request transport is implemented pending Project Codex review; RP-TURN-019 remains Partial, the protected Node destination remains unknown and the candidate remains unsigned, uninstalled and not production-approved  
