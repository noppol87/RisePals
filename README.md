...
**Project status:** RP-TURN-019-R4-NODE-DIAG2-R3 process-global Windows PowerShell security-module retention is implemented pending Project Codex review; RP-TURN-019 remains Partial, the protected Node destination remains unknown and the candidate remains unsigned, uninstalled and not production-approved  
