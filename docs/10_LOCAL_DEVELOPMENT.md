...
- No real profile/data, validated score/result/recommendation, saved XP or proof storage exists. RP-TURN-012 stores synthetic-alpha raw selected-option revision history; RP-TURN-013 stores only synthetic-alpha reproducible derived evidence and a bounded provisional priority; RP-TURN-015 adds only synthetic-alpha lesson/practice/progress state. Retention/export/erasure and production use remain open. RP-TURN-016 is not authorized or started.
