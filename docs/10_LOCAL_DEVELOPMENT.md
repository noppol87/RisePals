...
**Turn:** RP-TURN-019  
**Status:** RP-TURN-019-R4-NODE-DIAG2-R3 process-global Windows PowerShell security-module retention complete pending Project Codex review; NODE1/DIAG1 and RP-TURN-019 remain Partial, the protected Node destination remains unknown, the prototype remains unsigned/uninstalled and no real users/data, production database, CI or deployment exists  
**Checked:** 2026-08-28
