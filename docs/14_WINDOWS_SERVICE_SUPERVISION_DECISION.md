...
**Turn:** RP-TURN-019-R4  
**Status:** Option B repository-only prototype retained; R4-NODE-DIAG2-R3 process-global Windows PowerShell security-module retention complete pending Project Codex review while RP-TURN-019 remains Partial and the protected Node destination remains unknown  
