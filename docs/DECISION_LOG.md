...
- **Open:** Real users/data, production Clerk/PostgreSQL and operations, retention/export/erasure, learning-efficacy validation, saved XP/gamification, proof submission/review/storage, broader lesson versions, analytics, CI, infrastructure and deployment remain separate decisions. RP-TURN-016 is recommended only and not authorized.
