...
- **Open:** A database mirror/import, internal CMS, preview service, authoring roles and approval operations, additional lesson versions, real external evidence, efficacy validation, persistent attempts/progress/XP/proof, production delivery, CI, infrastructure and deployment require separate decisions. RP-TURN-015 is recommended only and is not authorized.
