...
- **Open:** Project Codex acceptance; production privacy/legal/data-residency suitability; purpose wording; retention/export/erasure and incident operations; external vendor/collector selection; staff access; aggregation/reporting; CI, infrastructure and deployment remain separate decisions. Real users/data, marketing attribution, experiments, page/click tracking, fingerprinting, saved XP, validation/proficiency and employment inference remain prohibited. RP-TURN-018 is recommended only and not authorized.
