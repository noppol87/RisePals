...
- **Open:** Real-user evidence, validation/efficacy, correction/replacement after ready, retention/export/erasure operations, uploads/object storage/scanning, sharing/external verification, credentials/certification, broader competency proof, XP/gamification, production identity/database/privacy/legal/data-residency suitability, CI, infrastructure and deployment require separate decisions. RP-TURN-017 was later authorized and Accepted for its bounded synthetic-alpha contract; RP-TURN-018 is recommended only and not authorized.
...
- **Open:** Production privacy/legal/data-residency suitability; purpose wording; retention/export/erasure and incident operations; external vendor/collector selection; staff access; aggregation/reporting; CI, infrastructure and deployment remain separate decisions. Real users/data, marketing attribution, experiments, page/click tracking, fingerprinting, saved XP, validation/proficiency and employment inference remain prohibited. RP-TURN-018 — Alpha Hardening and Recovery is recommended only and not authorized.
