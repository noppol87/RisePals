...
The executable project alone pins Version/InformationalVersion `0.1.0-rp19-prototype`, AssemblyVersion/FileVersion `0.1.0.0` and disables source-revision suffixing. The manifest records post-policy service-host production source tree `125eb5a7765c58cbc7cee094fbe82207642fd2a5`; volatile outer-repository commit metadata is excluded from artifact identity. Three independent clean publishes—one Git-aware and two file-only at distinct paths and timestamps—produced the exact same two output files. The executable pin is 73,606,961 bytes, SHA-256 `d86c4e4afcc8c1f6d8e77694b5de163185326c460fea1be50e5533d29aca0e8c`, NotSigned.
